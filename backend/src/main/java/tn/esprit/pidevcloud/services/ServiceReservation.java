...
public class ServiceReservation implements ReservationCrud{
    ...
    public void generateQRCode(Long idSalle) {
        ...
        try {
            ...
            String filePath = "C:\\Users\\Aziz\\Desktop\\piDevCloud\\backend\\src\\main\\java\\tn\\esprit\\pidevcloud\\qrCode\\qrCodeSalle"+selectedSalle.getId()+".png";
    ...
    public ResponseEntity<InputStreamResource> downloadQrCode(Long idSalle) throws IOException {
        File file = new File("C:\\Users\\Aziz\\Desktop\\piDevCloud\\backend\\src\\main\\java\\tn\\esprit\\pidevcloud\\qrCode\\qrCodeSalle"+idSalle+".png");
